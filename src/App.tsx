...
notFoundComponent: () => ( <div className="min-h-screen bg-[#141414] flex flex-col items-center justify-center gap-6 pt-16"> <div className="text-center"> <div className="text-8xl font-black text-[#E50914] mb-4">404</div> <h1 className="text-2xl font-bold text-white mb-2">Page Not Found</h1> <p className="text-zinc-400 mb-6">The page you're looking for doesn't exist.</p> </div> </div>
),
})
